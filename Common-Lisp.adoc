...
* Pathnames and operating system interfaces: `cl-pad`, `cl-cwd`, and `osicat`
  - http://weitz.de/cl-fad
  - https://www.common-lisp.net/project/osicat/manual/osicat.html
  - https://github.com/Inaimathi/cl-cwd/

* Core dumping: https://github.com/rolpereira/trivial-dump-core
